...
(function (w) {
    ...
    var ES = merge(EN, {
        ...
        err_heading: 'Algo salió mal',
        err_gateway: 'El servicio no está disponible temporalmente. Inténtelo de nuevo en un momento.',
        err_service_unavailable: 'Servicio no disponible temporalmente. Inténtelo más tarde.',
        err_server: 'Error del servidor. Inténtelo más tarde.',
        err_rate_limit: 'Demasiadas solicitudes. Espere e inténtelo de nuevo.',
    ...
    var AR = merge(EN, {
        ...
        err_heading: 'حدث خطأ',
        err_gateway: 'الخدمة غير متاحة مؤقتاً. يرجى المحاولة بعد قليل.',
        err_service_unavailable: 'الخدمة غير متاحة مؤقتاً.',
        err_server: 'خطأ في الخادم. يرجى المحاولة لاحقاً.',
        err_rate_limit: 'طلبات كثيرة. يرجى الانتظار والمحاولة مجدداً.',
