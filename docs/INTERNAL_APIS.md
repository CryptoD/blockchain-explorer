...
| [`internal/email`](../internal/email/) | Stable | [`EmailSender`](../internal/email/email_sender.go), [`SMTPSender`](../internal/email/smtp_sender.go), [`NoopEmailSender`](../internal/email/noop_sender.go), [`Service`](../internal/email/email.go) |
